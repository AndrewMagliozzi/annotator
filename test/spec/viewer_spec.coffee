describe 'Annotator.Viewer', ->
  ...
  describe "load", ->
    ...
    it "should pass the cloned field element and an annotation to the callback", ->
      ...
      assert.isTrue(args[2].showEdit)
      assert.isTrue(args[2].hideEdit)
      assert.isTrue(args[2].showDelete)
      assert.isTrue(args[2].hideDelete)
  ...
  describe "onButtonClick", ->
    ...
    it "should pass in the annotation object associated with the item", ->
      ...
      assert.equal(listener.mostRecentCall.args[1], annotation)
